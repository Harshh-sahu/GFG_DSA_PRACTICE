<h2><a href="https://www.geeksforgeeks.org/problems/c-data-types1523/1?page=1&category=Data%20Type&sortBy=submissions">C++ Data Types</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Read a value and store it in the appropriate C++ Data Type.&nbsp;</span></p>
